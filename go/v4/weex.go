...
func  (this *WeexCore) FetchMarginModes(optionalArgs ...any) <- chan any {
            ...
            retRes35058 := (<-this.LoadMarkets())
            PanicOnError(retRes35058)
            symbols = this.MarketSymbols(symbols)
...
func  (this *WeexCore) SetMarginMode(marginMode any, optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes354915 :=  (<-this.ContractPrivatePostCapiV3AccountMarginType(this.Extend(request, params)))
                PanicOnError(retRes354915)
                ch <- retRes354915
                return nil
...
func  (this *WeexCore) FetchLeverage(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes35748 := (<-this.LoadMarkets())
            PanicOnError(retRes35748)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *WeexCore) FetchLeverages(optionalArgs ...any) <- chan any {
            ...
            retRes35948 := (<-this.LoadMarkets())
            PanicOnError(retRes35948)
            symbols = this.MarketSymbols(symbols)
...
func  (this *WeexCore) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(IsTrue(IsTrue((IsEqual(isolatedLongLeverage, nil))) && IsTrue((IsEqual(isolatedShortLeverage, nil)))) && IsTrue((IsEqual(crossLeverage, nil)))) {
                ...
                retRes366415 :=  (<-this.ContractPrivatePostCapiV3AccountLeverage(this.Extend(request, params)))
                PanicOnError(retRes366415)
                ch <- retRes366415
                return nil
...
func  (this *WeexCore) FetchPositionMode(optionalArgs ...any) <- chan any {
            ...
            retRes36778 := (<-this.LoadMarkets())
            PanicOnError(retRes36778)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *WeexCore) SetPositionMode(hedged any, optionalArgs ...any) <- chan any {
            ...
            retRes37068 := (<-this.LoadMarkets())
            PanicOnError(retRes37068)
            var market any = this.Market(symbol)
            var marginMode any = nil
            ...
            var request any = map[string]any {
                ...
                retRes371915 :=  (<-this.ContractPrivatePostCapiV3AccountMarginType(this.Extend(request, params)))
                PanicOnError(retRes371915)
                ch <- retRes371915
                return nil
...
func  (this *WeexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes378015 :=  (<-this.ModifyMarginHelper(symbol, amount, 2, params))
                PanicOnError(retRes378015)
                ch <- retRes378015
                return nil
...
func  (this *WeexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes379515 :=  (<-this.ModifyMarginHelper(symbol, amount, 1, params))
