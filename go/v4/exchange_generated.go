...
func (this *Exchange) IsDictionary(value interface{}) interface{} {
...
func (this *Exchange) WatchLiquidations(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "watchLiquidationsForSymbols")) {
			...
			retRes310019 := (<-this.WatchLiquidationsForSymbols([]interface{}{symbol}, since, limit, params))
...
func (this *Exchange) WatchMyLiquidations(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "watchMyLiquidationsForSymbols")) {
			...
			ch <- <-this.DerivedExchange.WatchMyLiquidationsForSymbols([]interface{}{symbol}, since, limit, params)
			return nil
		}
...
func (this *Exchange) UnWatchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) UnWatchMarkPrices(optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) FeatureValueByType(marketType interface{}, subType interface{}, optionalArgs ...interface{}) interface{} {
	...
	var splited interface{} = Split(paramName, ".") // can be only parent key (`stopLoss`) or with child (`stopLoss.triggerPrice`)
	var parentKey interface{} = GetValue(splited, 0)
	var subKey interface{} = this.SafeString(splited, 1)
	if !IsTrue((InOp(methodDict, parentKey))) {
		return defaultValue // unsupported paramName, check "exchange.features" for details');
	}
	var dictionary interface{} = this.SafeDict(methodDict, parentKey)
...
func (this *Exchange) GetDescribeForExtendedWsExchange(currentRestInstance Describer, parentRestInstance Describer, wsBaseDescribe interface{}) interface{} {
...
func (this *Exchange) StringToBase16(str interface{}) interface{} {
...
func (this *Exchange) FetchSpotOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) FetchContractOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) FilterOutByArray(objects interface{}, key interface{}, optionalArgs ...interface{}) interface{} {
	values := GetArg(optionalArgs, 0, nil)
	_ = values
	indexed := GetArg(optionalArgs, 1, true)
	_ = indexed
...
func (this *Exchange) Fetch2(path interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(this.EnableRateLimit) {
			...
			retRes572212 := (<-this.Throttle(cost))
			PanicOnError(retRes572212)
		}
								...
								if IsTrue(IsInstance(e, OperationFailed)) {
									if IsTrue(IsLessThan(i, retries)) {
										...
										if IsTrue(IsTrue((!IsEqual(retryDelay, nil))) && IsTrue((!IsEqual(retryDelay, 0)))) {
											...
											retRes574428 := (<-this.Sleep(retryDelay))
											PanicOnError(retRes574428)
										}
									} else {
										panic(e)
									}
...
func (this *Exchange) Request(path interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes575815 := (<-this.Fetch2(path, api, method, params, headers, body, config))
		PanicOnError(retRes575815)
		ch <- retRes575815
		return nil
...
func (this *Exchange) BuildOHLCVC(trades interface{}, optionalArgs ...interface{}) interface{} {
	...
	var options interface{} = this.SafeDict(this.Options, "buildOHLCVC", map[string]interface{}{})
	var skipZeroPrices interface{} = this.SafeBool(options, "skipZeroPrices", true)
	for i := 0; IsLessThan(i, oldest); i++ {
		var trade interface{} = GetValue(trades, i)
		var ts interface{} = GetValue(trade, "timestamp")
		var price interface{} = GetValue(trade, "price")
		...
		var isFirstCandle interface{} = IsEqual(candle, OpNeg(1))
		if IsTrue(IsTrue(isFirstCandle) || IsTrue(IsGreaterThanOrEqual(openingTime, this.Sum(GetValue(GetValue(ohlcvs, candle), i_timestamp), ms)))) {
			...
			AppendToArray(&ohlcvs, []interface{}{openingTime, price, price, price, price, GetValue(trade, "amount"), 1})
		} else {
...
func (this *Exchange) EditLimitBuyOrder(id interface{}, symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes583715 := (<-this.EditLimitOrder(id, symbol, "buy", amount, price, params))
		PanicOnError(retRes583715)
		ch <- retRes583715
		return nil
...
func (this *Exchange) EditLimitSellOrder(id interface{}, symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes584115 := (<-this.EditLimitOrder(id, symbol, "sell", amount, price, params))
		PanicOnError(retRes584115)
		ch <- retRes584115
		return nil
...
func (this *Exchange) EditLimitOrder(id interface{}, symbol interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes584515 := <-this.DerivedExchange.EditOrder(id, symbol, "limit", side, amount, price, params)
		PanicOnError(retRes584515)
		ch <- retRes584515
		return nil
...
func (this *Exchange) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes58498 := <-this.DerivedExchange.CancelOrder(id, symbol)
		PanicOnError(retRes58498)

		retRes585015 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes585015)
		ch <- retRes585015
		return nil
...
func (this *Exchange) EditOrderWithClientOrderId(clientOrderId interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
		...
		retRes585515 := <-this.DerivedExchange.EditOrder("", symbol, typeVar, side, amount, price, extendedParams)
		PanicOnError(retRes585515)
		ch <- retRes585515
		return nil
...
func (this *Exchange) EditOrderWs(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes58598 := <-this.DerivedExchange.CancelOrderWs(id, symbol)
		PanicOnError(retRes58598)

		retRes586015 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes586015)
		ch <- retRes586015
		return nil
...
func (this *Exchange) WatchPositionForSymbols(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes588015 := <-this.DerivedExchange.WatchPositions(symbols, since, limit, params)
...
func (this *Exchange) FetchFreeBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes606715 := (<-this.FetchPartialBalance("free", params))
		PanicOnError(retRes606715)
		ch <- retRes606715
		return nil
...
func (this *Exchange) FetchUsedBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes607115 := (<-this.FetchPartialBalance("used", params))
		PanicOnError(retRes607115)
		ch <- retRes607115
		return nil
...
func (this *Exchange) FetchTotalBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes607515 := (<-this.FetchPartialBalance("total", params))
		PanicOnError(retRes607515)
		ch <- retRes607515
		return nil
...
func (this *Exchange) FetchTransactionFee(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes608615 := (<-this.FetchTransactionFees([]interface{}{code}, params))
		PanicOnError(retRes608615)
		ch <- retRes608615
		return nil
...
func (this *Exchange) FetchIsolatedBorrowRate(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes61278 := (<-this.LoadMarkets())
		PanicOnError(retRes61278)
		if !IsTrue(GetValue(this.Has, "fetchBorrowRates")) {
...
func (this *Exchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchTickers")) {
			...
			retRes630412 := (<-this.LoadMarkets())
			PanicOnError(retRes630412)
...
func (this *Exchange) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkPrices")) {
			...
			retRes632112 := (<-this.LoadMarkets())
			PanicOnError(retRes632112)
...
func (this *Exchange) FetchTickerWs(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchTickersWs")) {
			...
			retRes633812 := (<-this.LoadMarkets())
			PanicOnError(retRes633812)

			var market interface{} = this.DerivedExchange.Market(symbol)
			PanicOnError(market)
			symbol = GetValue(market, "symbol")

			tickers := <-this.DerivedExchange.FetchTickersWs([]interface{}{symbol}, params)
			PanicOnError(tickers)
			var ticker interface{} = this.SafeDict(tickers, symbol)
			if IsTrue(IsEqual(ticker, nil)) {
...
func (this *Exchange) FetchSpotTickers(optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) FetchContractTickers(optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) FetchOrderWithClientOrderId(clientOrderId interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes641215 := <-this.DerivedExchange.FetchOrder("", symbol, extendedParams)
		PanicOnError(retRes641215)
		ch <- retRes641215
		return nil
...
func (this *Exchange) FetchUnifiedOrder(order interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes642715 := <-this.DerivedExchange.FetchOrder(this.SafeString(order, "id"), this.SafeString(order, "symbol"), params)
...
func (this *Exchange) FetchPositionADLRank(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchPositionsADLRank")) {
			...
			retRes646412 := (<-this.LoadMarkets())
			PanicOnError(retRes646412)
...
func (this *Exchange) CreateTrailingAmountOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrder")) {
			...
			retRes650219 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes650219)
			ch <- retRes650219
			return nil
		}
...
func (this *Exchange) CreateTrailingAmountOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrderWs")) {
			...
			retRes653019 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateTrailingPercentOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrder")) {
			...
			retRes655819 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes655819)
			ch <- retRes655819
			return nil
		}
...
func (this *Exchange) CreateTrailingPercentOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrderWs")) {
			...
			retRes658619 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes658619)
			ch <- retRes658619
			return nil
		}
...
func (this *Exchange) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCost")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))))) {
			...
			retRes660319 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, cost, 1, params)
			PanicOnError(retRes660319)
			ch <- retRes660319
			return nil
		}
...
func (this *Exchange) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketBuyOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost"))) {
			...
			retRes661919 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", cost, 1, params)
			PanicOnError(retRes661919)
			ch <- retRes661919
			return nil
		}
...
func (this *Exchange) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketSellOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))) {
			...
			retRes663519 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", cost, 1, params)
			PanicOnError(retRes663519)
			ch <- retRes663519
			return nil
		}
...
func (this *Exchange) CreateMarketOrderWithCostWs(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCostWs")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCostWs")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCostWs"))))) {
			...
			retRes665219 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, cost, 1, params)
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLoss(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLoss")) {
			...
			retRes682619 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLossWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLossWs")) {
			...
			retRes690619 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes690619)
			ch <- retRes690619
			return nil
		}
...
func (this *Exchange) CreateSpotOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CreateContractOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CancelSpotOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CancelContractOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CancelOrderWithClientOrderId(clientOrderId interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes695415 := <-this.DerivedExchange.CancelOrder("", symbol, extendedParams)
		PanicOnError(retRes695415)
		ch <- retRes695415
		return nil
...
func (this *Exchange) CancelOrders(ids interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CancelOrdersWithClientOrderIds(clientOrderIds interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes697615 := (<-this.CancelOrders([]interface{}{}, symbol, extendedParams))
		PanicOnError(retRes697615)
		ch <- retRes697615
		return nil
...
func (this *Exchange) CancelAllSpotOrders(optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CancelAllContractOrders(optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) FetchContractDepositAddress(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CreateLimitOrder(symbol interface{}, side interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes728815 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, params)
		PanicOnError(retRes728815)
		ch <- retRes728815
		return nil
...
func (this *Exchange) CreateLimitOrderWs(symbol interface{}, side interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes729215 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", side, amount, price, params)
...
func (this *Exchange) CreateMarketOrder(symbol interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes729615 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, price, params)
		PanicOnError(retRes729615)
		ch <- retRes729615
		return nil
...
func (this *Exchange) CreateMarketOrderWs(symbol interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes730015 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, amount, price, params)
		PanicOnError(retRes730015)
		ch <- retRes730015
		return nil
...
func (this *Exchange) CreateLimitBuyOrder(symbol interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes730415 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "buy", amount, price, params)
		PanicOnError(retRes730415)
		ch <- retRes730415
		return nil
...
func (this *Exchange) CreateLimitBuyOrderWs(symbol interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes730815 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", "buy", amount, price, params)
...
func (this *Exchange) CreateLimitSellOrder(symbol interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes731215 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "sell", amount, price, params)
		PanicOnError(retRes731215)
		ch <- retRes731215
		return nil
...
func (this *Exchange) CreateLimitSellOrderWs(symbol interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes731615 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", "sell", amount, price, params)
		PanicOnError(retRes731615)
		ch <- retRes731615
		return nil
...
func (this *Exchange) CreateMarketBuyOrder(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes732015 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes732015)
		ch <- retRes732015
		return nil
...
func (this *Exchange) CreateMarketBuyOrderWs(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes732415 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes732415)
		ch <- retRes732415
		return nil
...
func (this *Exchange) CreateMarketSellOrder(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes732815 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes732815)
		ch <- retRes732815
		return nil
...
func (this *Exchange) CreateMarketSellOrderWs(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes733215 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes733215)
		ch <- retRes733215
		return nil
...
func (this *Exchange) CreatePostOnlyOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes750215 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes750215)
		ch <- retRes750215
		return nil
...
func (this *Exchange) CreatePostOnlyOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes751015 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes751015)
		ch <- retRes751015
		return nil
...
func (this *Exchange) CreateReduceOnlyOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes751815 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes751815)
		ch <- retRes751815
		return nil
...
func (this *Exchange) CreateReduceOnlyOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes752615 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes752615)
		ch <- retRes752615
		return nil
...
func (this *Exchange) CreateStopOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes753715 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes753715)
		ch <- retRes753715
		return nil
...
func (this *Exchange) CreateStopOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes754815 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateStopLimitOrder(symbol interface{}, side interface{}, amount interface{}, price interface{}, triggerPrice interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes755615 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, query)
...
func (this *Exchange) CreateStopLimitOrderWs(symbol interface{}, side interface{}, amount interface{}, price interface{}, triggerPrice interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes756415 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", side, amount, price, query)
		PanicOnError(retRes756415)
		ch <- retRes756415
		return nil
...
func (this *Exchange) CreateStopMarketOrder(symbol interface{}, side interface{}, amount interface{}, triggerPrice interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes757215 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, nil, query)
...
func (this *Exchange) CreateStopMarketOrderWs(symbol interface{}, side interface{}, amount interface{}, triggerPrice interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes758015 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes758015)
		ch <- retRes758015
		return nil
...
func (this *Exchange) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingRates")) {
			...
			retRes796412 := (<-this.LoadMarkets())
			PanicOnError(retRes796412)
...
func (this *Exchange) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingIntervals")) {
			...
			retRes798412 := (<-this.LoadMarkets())
			PanicOnError(retRes798412)
...
func (this *Exchange) FetchMarkOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkOHLCV")) {
			...
			retRes801819 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes801819)
			ch <- retRes801819
			return nil
		} else {
...
func (this *Exchange) FetchIndexOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchIndexOHLCV")) {
			...
			retRes804019 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes804019)
			ch <- retRes804019
			return nil
		} else {
...
func (this *Exchange) FetchPremiumIndexOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchPremiumIndexOHLCV")) {
			...
			retRes806219 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes806219)
			ch <- retRes806219
			return nil
		} else {
...
func (this *Exchange) FetchTransactions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Has, "fetchDepositsWithdrawals")) {
			...
			retRes827219 := <-this.DerivedExchange.FetchDepositsWithdrawals(code, since, limit, params)
			PanicOnError(retRes827219)
			ch <- retRes827219
			return nil
		} else {
...

			{
				func(this *Exchange) (ret_ interface{}) {
					...
					if IsTrue(IsTrue(timeframe) && IsTrue(!IsEqual(method, "fetchFundingRateHistory"))) {
						...
						retRes841827 := (<-this.CallDynamically(method, symbol, timeframe, since, limit, params))
						PanicOnError(retRes841827)
						ch <- retRes841827
						return nil
					} else {

						retRes842027 := (<-this.CallDynamically(method, symbol, since, limit, params))
						PanicOnError(retRes842027)
						ch <- retRes842027
						return nil
					}
...
func (this *Exchange) LoadMarketsAndSignIn() <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes89198 := (<-promiseAll([]interface{}{this.LoadMarkets(), <-this.callInternal("signIn")}))
		PanicOnError(retRes89198)
		return nil
	}()
	return ch
}
...
func (this *Exchange) UnWatchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) WatchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) WatchMarkPrices(optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) WithdrawWs(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) UnWatchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CreateOrdersWs(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) FetchOrdersByStatusWs(status interface{}, optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) UnWatchBidsAsks(optionalArgs ...interface{}) <-chan interface{} {
	ch := make(chan interface{})
	go func() interface{} {
		defer close(ch)
		defer ReturnPanicError(ch)
...
func (this *Exchange) CleanCache(subscription interface{}) {
	...
	if IsTrue(IsEqual(topic, "ohlcv")) {
		...
		if IsTrue(IsTrue(IsEqual(topic, "myTrades")) && IsTrue((!IsEqual(this.MyTrades, nil)))) {
			...
			var bidsaskSymbols interface{} = ObjectKeys(this.Bidsasks)
			for i := 0; IsLessThan(i, GetArrayLength(bidsaskSymbols)); i++ {
				var bidsaskSymbol interface{} = GetValue(bidsaskSymbols, i)
